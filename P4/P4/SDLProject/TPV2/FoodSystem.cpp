...
void FoodSystem::onEat(Entity *e) {
	...
	if (numOfFoodPieces_ == 0)
		mngr_->send<msg::Message>(msg::_NOMOREFOOD);
}
...
void FoodSystem::recieve(const msg::Message& msg)
{
	switch (msg.id)
	{
	case msg::_GAME_START: addFood(10);	break;
	case msg::_GAME_OVER:disableAll(); break;
	case msg::_EATFRUIT:onEat(static_cast<const msg::EatFruit&>(msg).e); break;
	default: break;
	}
}
